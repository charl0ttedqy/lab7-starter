...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		this.articleEle = document.createElement('article');
		...
		* {
		...
		this.shadowRoot.append(this.styleEle);
		this.shadowRoot.append(this.articleEle);
	}
	...
	set data(data) {
		...
		this.articleEle.innerHTML = `
			...
			<div class="rating">
				...
				<img src="https://github.com/charl0ttedqy/lab7-starter/tree/master/assets/images/icons/${data.rating}-star.svg" alt="${data.rating} stars">
